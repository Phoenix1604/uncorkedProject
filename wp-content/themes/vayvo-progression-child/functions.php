...
/**
 * Remove the default mega menu class from the action hook and add custom class
 */
function remove_mega_menu_function() {
	global $ProgressionMegaMenuFramework;
	remove_action( 'progression_studios_init', array( $ProgressionMegaMenuFramework, 'include_functions' ) );
	add_action( 'progression_studios_init', 'add_custom_mega_menu_class' );
}
...
function include_functions() {
	...
	$ProgressionMegaMenuFramework::$_classes['menus'] = new ProgressionMegaMenu();

}
add_action( 'plugins_loaded', 'remove_mega_menu_function' );
